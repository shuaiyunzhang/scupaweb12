...
(function(a){
    a.fn.desSlideshow=function(p){
        ...
        var slideshow_width=p&&p.slideshow_width?p.slideshow_width:"960";
        var slideshow_height=p&&p.slideshow_height?p.slideshow_height:"300";
        var thumbnail_width=p&&p.thumbnail_width?p.thumbnail_width:"300";
        ...
        function init(){
            ...
            g.find(".switchBigPic").children("div").children("p").css("position","absolute").css("padding","10px").css("bottom","0px").css("opacity","0.6").css("background-color","#000").css("color","#FFF").css("font-family","Microsoft Yahei").css("text-align","center").css("font-size","12.5px").css("line-height","18px").css("height","48px").css("text-indent","20px").css("overflow","hidden").css("width","720px");
            g.find(".nav").css("width",thumbnail_width+"px").css("height",slideshow_height+"px").css("position","relative").css("left","720px");
            g.find(".nav").children("li").css("height","54px").css("background-image","url("+directory+"flashtext-bg.jpg)").css("line-height","49px").css("border-bottom","1px solid #CCCCCC").css("border-right","1px solid #CCCCCC");
            g.find(".nav").children("li").children("a").css("text-overflow","ellipsis").css("height","49px").css("display","inline-block").css("padding-left","25px").css("font-size","14px");
            g.find("#last_a").css("padding-left","0").css("font-size","16px");
        ...
        function showpic(){
            ...
            g.find(".nav").children("li").children("a").css("color","rgb(0, 0, 0)");
            g.find(".nav").children("li").children("a").eq(current).css("color","rgb(255, 255, 255)");
